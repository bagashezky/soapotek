	...
	<div class="nav_menu">
		<nav>
			...
			<ul class="nav navbar-nav navbar-right">
				<li>
					<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="<?php echo base_url('assets/images/img.jpg') ?>" alt="">Admin <span class="fa fa-angle-down"></span></a>
                    ...
                    <li>
                      <a href="<?php echo base_url('example/table_exp') ?>">
                        ...
                        <span style="font-size: 15px;">
                          <span> Kedaluawarsa</span>
                          <span class="time"><?php echo $nullex ?> obat</span>
                        </span>
                        <span class="message">
                          Obat sudah Kedaluawarsa...
                        </span>
                      </a>
                    </li>
                    <li>
